...
function ciniki_ags_objects(&$ciniki) {
    ...
    $objects['exhibit'] = array(
        ...
        'fields' => array(
            ...
            'application_description' => array('name'=>'Application Description', 'default'=>''),
    ...
    $objects['item'] = array(
        ...
        'fields' => array(
            ...
            'sapos_category' => array('name'=>'Accounting Category', 'default'=>''),
    ...
    $objects['itemsale'] = array(
        ...
        'fields' => array(
            ...
            'tenant_tax_amount' => array('name'=>'Business Tax Amount', 'default'=>'0'),
