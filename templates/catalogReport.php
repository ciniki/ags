...
// -------
//
function ciniki_ags_templates_catalogReport(&$ciniki, $tnid, $args) {
    ...
    class MYPDF extends TCPDF {
        ...
        public function Header() {
            ...
            //
            $this->SetFont('', 'B', 12);
            $this->Cell(196, 12, $this->title, 1, false, 'C', 0);
        }
        ...
        public function Footer() {
            ...
            if( isset($this->footer_msg) && $this->footer_msg != '' ) {
                $this->Cell(98, 10, $this->footer_msg,
                    0, false, 'L', 0, '', 0, false, 'T', 'M');
                $this->Cell(98, 10, 'Page ' . $this->getPageNumGroupAlias().'/'.$this->getPageGroupAlias(), 
