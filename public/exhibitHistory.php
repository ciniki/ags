...
// Description
// -----------
// This method will return the list of actions that were applied to an element of an exhibit.
...
// exhibit_id:          The ID of the exhibit to get the history for.
// field:                   The field to get the history for.
//
// Returns
// -------
//
function ciniki_ags_exhibitHistory($ciniki) {
    //
    ...
    $rc = ciniki_ags_checkAccess($ciniki, $args['tnid'], 'ciniki.ags.exhibitHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
