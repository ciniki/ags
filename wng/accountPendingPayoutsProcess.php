...
// -------
//
function ciniki_ags_wng_accountPendingPayoutsProcess(&$ciniki, $tnid, &$request, $item) {
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.ags.316', 'msg'=>'Unable to load sales', 'err'=>$rc['err']));
    }
...
//                array('text'=>'Download Excel', 'url'=>$base_url . '/download/excel'),
    ...
    $blocks[] = array(
        ...
        'footer' => array(
            ...
            array('fold-label'=>'Sales: ', 'class'=>'alignright', 'value'=>'$' . number_format($totals['total_amount'], 2)),
            array('fold-label'=>'Fees: ', 'class'=>'alignright', 'value'=>'$' . number_format($totals['tenant_amount'], 2)),
            array('fold-label'=>'Payouts: ', 'class'=>'alignright', 'value'=>'$' . number_format($totals['exhibitor_amount'], 2)),
            ),
        );
