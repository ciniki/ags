...
function ciniki_ags_wng_accountPendingPayoutsProcess(&$ciniki, $tnid, &$request, $item) {
    ...
    $blocks[] = array(
        ...
        'footer' => array(
            ...
            array('fold-label'=>'Total Fees: ', 'value'=>'$' . number_format($totals['tenant_amount'], 2)),
            array('fold-label'=>'Total Payouts: ', 'value'=>'$' . number_format($totals['exhibitor_amount'], 2)),
            array('fold-label'=>'Total Sales: ', 'value'=>'$' . number_format($totals['total_amount'], 2)),
            ),
        );
